      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6 mb-5" data-aos="fade-up" data-aos-delay="">
            ...
            <img src="<c:url value="resources/images/hero_1.jpg"/>" alt="Free Website Template by Free-Template.co" class="img-fluid">
            </figure>
          </div>
          ...
          <div class="col-md-6 col-lg-3 mb-4" data-aos="fade-up" data-aos-delay="">
            <div class="team-member">
              <figure>
                ...
                <img src="<c:url value="resources/images/person_5.jpg"/>" alt="Image" class="img-fluid">
              </figure>
              <div class="p-3">
          ...
          <div class="col-md-6 col-lg-3 mb-4" data-aos="fade-up" data-aos-delay="100">
            <div class="team-member">
              <figure>
                ...
                <img src="<c:url value="resources/images/person_6.jpg"/>" alt="Image" class="img-fluid">
              </figure>
              <div class="p-3">
                <h3>Dave Simpson</h3>
          ...
          <div class="col-md-6 col-lg-3 mb-4" data-aos="fade-up" data-aos-delay="200">
            <div class="team-member">
              <figure>
                ...
                <img src="<c:url value="resources/images/person_7.jpg"/> " alt="Image" class="img-fluid">
              </figure>
              <div class="p-3">
                <h3>Ben Thompson</h3>
          ...
          <div class="col-md-6 col-lg-3 mb-4" data-aos="fade-up" data-aos-delay="300">
            <div class="team-member">
              <figure>
                ...
                <img src="<c:url value="resources/images/person_8.jpg"/>" alt="Image" class="img-fluid">
              </figure>
              <div class="p-3">
                <h3>Kyla Stewart</h3>
                <span class="position">Accountant</span>
          ...
          <div class="col-md-6 col-lg-3 mb-4" data-aos="fade-up" data-aos-delay="">
            <div class="team-member">
              <figure>
                ...
                <img src="<c:url value="resources/images/person_1.jpg"/>" alt="Image" class="img-fluid">
              </figure>
              <div class="p-3">
                <h3>Kaiara Spencer</h3>
                <span class="position">Accountant</span>
          ...
          <div class="col-md-6 col-lg-3 mb-4" data-aos="fade-up" data-aos-delay="100">
            <div class="team-member">
              <figure>
                ...
                <img src="<c:url value="resources/images/person_2.jpg"/>" alt="Image" class="img-fluid">
              </figure>
              <div class="p-3">
                <h3>Dave Simpson</h3>
          ...
          <div class="col-md-6 col-lg-3 mb-4" data-aos="fade-up" data-aos-delay="200">
            <div class="team-member">
              <figure>
                ...
                <img src="<c:url value="resources/images/person_3.jpg"/>" alt="Image" class="img-fluid">
              </figure>
              <div class="p-3">
                <h3>Ben Thompson</h3>
                <span class="position">Bank Teller</span>
          ...
          <div class="col-md-6 col-lg-3 mb-4" data-aos="fade-up" data-aos-delay="300">
            <div class="team-member">
              <figure>
                ...
                <img src="<c:url value="resources/images/person_4.jpg"/>" alt="Image" class="img-fluid">
              </figure>
              <div class="p-3">
                <h3>Chris Stewart</h3>
                <span class="position">Bank Teller</span>
      ...
      <div class="container">
        ...
        <div id="posts" class="row no-gutter">
          <div class="item web col-sm-6 col-md-4 col-lg-4 col-xl-3 mb-4">
            <a href="<c:url value="resources/images/img_1.jpg"/>" class="item-wrap fancybox">
              <span class="icon-search2"></span>
              <img class="img-fluid" src="<c:url value="resources/images/img_1.jpg"/>">
            </a>
          </div>
          <div class="item web col-sm-6 col-md-4 col-lg-4 col-xl-3 mb-4">
            <a href="<c:url value="resources/images/img_2.jpg"/>" class="item-wrap fancybox" data-fancybox="gallery2">
              <span class="icon-search2"></span>
              <img class="img-fluid" src="<c:url value="resources/images/img_2.jpg"/>">
            </a>
          </div>

          <div class="item brand col-sm-6 col-md-4 col-lg-4 col-xl-3 mb-4">
            <a href="<c:url value="resources/images/img_3.jpg"/>" class="item-wrap fancybox" data-fancybox="gallery2">
              <span class="icon-search2"></span>
              <img class="img-fluid" src="<c:url value="resources/images/img_3.jpg"/>">
            </a>
          </div>

          <div class="item design col-sm-6 col-md-4 col-lg-4 col-xl-3 mb-4">

            <a href="<c:url value="resources/images/img_4.jpg"/>" class="item-wrap fancybox" data-fancybox="gallery2">
              <span class="icon-search2"></span>
              <img class="img-fluid" src="<c:url value="resources/images/img_4.jpg"/>">
            </a>

          </div>

          <div class="item web col-sm-6 col-md-4 col-lg-4 col-xl-3 mb-4">
            <a href="<c:url value="resources/images/img_5.jpg"/>" class="item-wrap fancybox" data-fancybox="gallery2">
              <span class="icon-search2"></span>
              <img class="img-fluid" src="<c:url value="resources/images/img_5.jpg"/>">
            </a>
          </div>

          <div class="item brand col-sm-6 col-md-4 col-lg-4 col-xl-3 mb-4">
            <a href="<c:url value="resources/images/img_1.jpg"/>" class="item-wrap fancybox" data-fancybox="gallery2">
              <span class="icon-search2"></span>
              <img class="img-fluid" src="<c:url value="resources/images/img_1.jpg"/>">
            </a>
          </div>
        ...
        <div class="row align-items-lg-center" >
          <div class="col-lg-6 mb-5" data-aos="fade-up" data-aos-delay="">
            ...
            <div class="owl-carousel slide-one-item-alt">
              <img src="<c:url value="resources/images/slide_1.jpg"/>" alt="Image" class="img-fluid">
              <img src="<c:url value="resources/images/slide_2.jpg"/>" alt="Image" class="img-fluid">
              <img src="<c:url value="resources/images/slide_3.jpg"/>" alt="Image" class="img-fluid">
            </div>
      ...
      <div class="container">
        ...
        <div class="row align-items-stretch">
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4" data-aos="fade-up" data-aos-delay="200">
            <div class="unit-4">
              <div class="unit-4-icon">
                <img src="<c:url value="resources/images/flaticon-svg/svg/002-rich.svg"/>" alt="Free Website Template by Free-Template.co" class="img-fluid w-25 mb-4">
              </div>
              <div>
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4" data-aos="fade-up" data-aos-delay="">
            <div class="unit-4">
              <div class="unit-4-icon">
                <img src="<c:url value="resources/images/flaticon-svg/svg/003-notes.svg"/>" alt="Free Website Template by Free-Template.co" class="img-fluid w-25 mb-4">
              </div>
              <div>
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4" data-aos="fade-up" data-aos-delay="200">
            <div class="unit-4">
              <div class="unit-4-icon">
                <img src="<c:url value="resources/images/flaticon-svg/svg/005-megaphone.svg"/>" alt="Free Website Template by Free-Template.co" class="img-fluid w-25 mb-4">
              </div>
              <div>
      ...
      <div class="slide-one-item home-slider owl-carousel">
          <div>
            <div class="testimonial">
              ...
              <figure class="mb-4 d-flex align-items-center justify-content-center">
                <div><img src="<c:url value="resources/images/person_3.jpg"/>" alt="Image" class="w-50 img-fluid mb-3"></div>
                <p>John Smith</p>
              </figure>
            </div>
          </div>
          <div>
            <div class="testimonial">
              ...
              <figure class="mb-4 d-flex align-items-center justify-content-center">
                <div><img src="<c:url value="resources/images/person_2.jpg"/>" alt="Image" class="w-50 img-fluid mb-3"></div>
          ...
          <div>
            <div class="testimonial">
              ...
              <figure class="mb-4 d-flex align-items-center justify-content-center">
                <div><img src="<c:url value="resources/images/person_4.jpg"/>" alt="Image" class="w-50 img-fluid mb-3"></div>
                <p>Robert Spears</p>
              </figure>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4" data-aos="fade-up" data-aos-delay="">
            <div class="h-entry">
              <a href="single.html">
                <img src="<c:url value="resources/images/img_1.jpg"/>" alt="Image" class="img-fluid">
              </a>
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4" data-aos="fade-up" data-aos-delay="100">
            <div class="h-entry">
              <a href="single.html">
                <img src="<c:url value="resources/images/img_4.jpg"/>" alt="Image" class="img-fluid">
              </a>
              <h2 class="font-size-regular"><a href="#">A Basic Guide to Starting a Franchise in the Philippines</a></h2>
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4" data-aos="fade-up" data-aos-delay="200">
            <div class="h-entry">
              <a href="single.html">
                <img src="<c:url value="resources/images/img_3.jpg"/>" alt="Image" class="img-fluid">
              </a>
              <h2 class="font-size-regular"><a href="#">A Basic Guide to Starting a Franchise in the Philippines</a></h2>
              <div class="meta mb-4">James Phelps <span class="mx-2">&bullet;</span> Jan 18, 2019<span class="mx-2">&bullet;</span> <a href="#">News</a></div>
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus eligendi nobis ea maiores sapiente veritatis reprehenderit suscipit quaerat rerum voluptatibus a eius.</p>
